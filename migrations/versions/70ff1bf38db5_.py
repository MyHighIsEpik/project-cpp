...
Revision ID: 70ff1bf38db5
Revises: 1c4d55d959c4
Create Date: 2021-11-02 02:06:20.582305
...
revision = '70ff1bf38db5'
down_revision = '1c4d55d959c4'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    with op.batch_alter_table('question', schema=None) as batch_op:
        batch_op.add_column(sa.Column('user_codenum', mysql.INTEGER(), autoincrement=False, nullable=True))
