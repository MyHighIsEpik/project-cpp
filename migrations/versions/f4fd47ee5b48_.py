...
Revision ID: f4fd47ee5b48
Revises: 64b1d16822f5
Create Date: 2021-11-04 05:02:46.302865
...
revision = 'f4fd47ee5b48'
down_revision = '64b1d16822f5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('answer', schema=None) as batch_op:
        batch_op.drop_index('fk_answer_question_id_question_idx')
        batch_op.drop_index('fk_answer_user_id_user_idx')
...
def downgrade():
    ...
    with op.batch_alter_table('answer', schema=None) as batch_op:
        ...
        batch_op.create_index('fk_answer_user_id_user_idx', ['user_id'], unique=False)
        batch_op.create_index('fk_answer_question_id_question_idx', ['question_id'], unique=False)
